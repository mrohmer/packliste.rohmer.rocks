...
{#if typeof dark === 'boolean'}
	<div on:click={() => changeTheme()} class="flex justify-center">
		<div
			class="transition-colors duration-200 cursor-pointer w-20 h-10 rounded-3xl bg-[#83D8FF]"
			class:dark
			class:bg-[#749DD6]={dark}
		>
			<div
				class="toggle__handler z-10 top-0.5 left-0.5 w-9 h-9 bg-[#FFCF96] rounded-full -rotate-45"
			>
