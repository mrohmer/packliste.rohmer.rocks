...
<div class="checkbox w-full h-10 rounded-lg p-2.5 flex items-center mb-px">
	<div
		class="absolute top-0 left-0 right-0 bottom-0 w-full h-full cursor-pointer"
...
<style lang="postcss">
	...
	@keyframes firework {
		0% {
			opacity: 1;
			box-shadow: 0 0 0 -2px #236bef, 0 0 0 -2px #236bef, 0 0 0 -2px #236bef, 0 0 0 -2px #236bef,
				0 0 0 -2px #236bef, 0 0 0 -2px #236bef;
		}
		30% {
			opacity: 1;
		}
		100% {
			opacity: 0;
			box-shadow: 0 -15px 0 0px #236bef, 14px -8px 0 0px #236bef, 14px 8px 0 0px #236bef,
				0 15px 0 0px #236bef, -14px 8px 0 0px #236bef, -14px -8px 0 0px #236bef;
		}
	}
</style>
