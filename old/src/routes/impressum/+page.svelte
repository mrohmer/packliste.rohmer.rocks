...
<div class="mt-20 mb-4 max-w-4xl mx-auto px-2">
    ...
    <h2>Kontakt</h2>
    <p>
        E-Mail: matthias@rohmer.rocks
    </p>

    <p>
        Die Anschrift erhalten Sie auf Anfrage.
    </p>
    ...
    <p>
        Quelle: <a rel="noreferrer noopener" href="https://www.erecht24.de/impressum-generator.html" target="_blank">https://www.e-recht24.de/</a>
    </p>
</div>
